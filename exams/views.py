...
def start_exam(request, exam_id):
    ...
    if request.method == "POST":
        ...
        for question in questions:
            ...
            if str(selected).strip() == str(question.correct_answer).strip():
                score += 1
        ...
        # Clear saved question list after submission
    ...
    # GET request: choose random half of uploaded questions only once
    ...
    # Always show half
    questions_to_show = total_uploaded // 2

    # If only 1 question exists, show 1
    if total_uploaded == 1:
        questions_to_show = 1
